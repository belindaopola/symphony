...
if (isset($_POST['submit'])) {
    ...
    if ($_FILES['quotation']['error'] === UPLOAD_ERR_OK) {
        ...
        $q_last_id_query = "SELECT MAX(id) AS q_last_id FROM tbl_request";
    ...
    if ($_FILES['customer_po']['error'] === UPLOAD_ERR_OK) {
        ...
        $p_last_id_query = "SELECT MAX(id) AS p_last_id FROM tbl_request";
    ...
    if ($_FILES['costing_sheet']['error'] === UPLOAD_ERR_OK) {
        ...
        $c_last_id_query = "SELECT MAX(id) AS c_last_id FROM tbl_request";
...
<section class="main-content">
    <div class="wrapper">
        <h1 class="text-center row mb-4">Create New TS CSR</h1>
