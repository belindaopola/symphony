    ...
    <div class="wrapper">
        ...
        <?php 
            ...
            if(isset($_GET['id'])) {
                ...
                header('location:' . SITEURL . 'manage-it_request.php');
            }
        ?>
        ...
        <?php 
            if(isset($_POST['submit'])) {
                ...
                // Upload paths
                $quotation_target = "uploads/files_it/quotation/" . basename($quotation);
                $customer_po_target = "uploads/files_it/po/" . basename($customer_po);
                $costing_sheet_target = "uploads/files_it/costing/" . basename($costing_sheet);
