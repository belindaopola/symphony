                ...
                if(mysqli_num_rows($res) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL; ?>update-customer.php?id=<?php echo $id; ?>" class="btn-secondary">Update Customer</a>
                                <a href="<?php echo SITEURL; ?>delete-customer.php?id=<?php echo $id; ?>" class="btn-danger">Delete Customer</a>
                            </td>
                        </tr>
                        <?php
                    }
